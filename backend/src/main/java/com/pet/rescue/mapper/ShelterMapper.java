...
public interface ShelterMapper extends BaseMapper<Shelter> {
     ...
     */
    @InterceptorIgnore(tenantLine = "true")
    @Update("UPDATE shelter SET current_capacity = #{currentCapacity} WHERE id = #{id}")
     ...
     */
    @InterceptorIgnore(tenantLine = "true")
    @Update("UPDATE shelter SET entry_status = #{entryStatus}, entry_time = #{entryTime} WHERE id = #{id}")
     ...
     */
    @InterceptorIgnore(tenantLine = "true")
    @Update("UPDATE shelter SET audit_status = #{auditStatus}, audit_comment = #{auditComment} WHERE id = #{id}")
